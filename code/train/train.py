...
parser.add_argument('--model_params', type=str, default='checkpoints/model-last.ckpt', help='model binary for starting chat')
...
TOKENIZER = PreTrainedTokenizerFast.from_pretrained("skt/kogpt2-base-v2", eos_token=EOS, unk_token='<unk>', pad_token=PAD, mask_token=MASK) 
...
class KoGPT2Chat(LightningModule):
    ...
    def train_dataloader(self):
        ...
        train_dataloader = DataLoader(self.train_set, batch_size=self.hparams.batch_size, num_workers=4, shuffle=True, collate_fn=self._collate_fn)
