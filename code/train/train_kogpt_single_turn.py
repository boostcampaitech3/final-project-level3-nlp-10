...
class My_Dataset(Dataset):
    def __init__(self, tokenizer):
        ...
        self.data = []
<<<<<<< HEAD:code/train/train_kogpt_single_turn.py
        self.file_path = "../../data/dialog_single_turn.csv"
=======
        self.file_path = "../data/dialog_single_turn.csv"
>>>>>>> ee8d1d69fc284b8925c710663c8473c3b90802fe:chatbot/code/train_kogpt_single_turn.py
...
def train():
  ...
  for epoch in range(epochs):
    ...
    for data in data_loader:
        ...
        count += 1
  torch.save(model.state_dict(), os.path.join(f'../model', 'single_turn_model.bin'))
